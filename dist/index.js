...
async function runAction() {
  ...
  try {
    ...
    const account_id = (0,core.getInput)('account_id')
    const bucket_id = (0,core.getInput)('bucket_id')
    const chat_id = (0,core.getInput)('chat_id')
...
var __webpack_exports__runAction = __webpack_exports__.w;
export { __webpack_exports__runAction as runAction };
