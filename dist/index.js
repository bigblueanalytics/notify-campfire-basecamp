...
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(8865);



try {
  const basecamp_token = process.env.BASECAMP_CHATBOT_SECRET
  const account_id = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('account_id')
  const bucket_id = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('bucket_id')
  const chat_id = (0,_actions_core__WEBPACK_IMPORTED_MODULE_0__.getInput)('chat_id')
